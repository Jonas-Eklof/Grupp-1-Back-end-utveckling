...
// Definiera sökvägen till databasens mapp och fil
const dbDir = path.join(__dirname, "db");
const dbPath = path.join(dbDir, "database.db");

// Kontrollera om mappen finns, om inte, skapa den
if (!fs.existsSync(dbDir)) {
  fs.mkdirSync(dbDir, { recursive: true });
  console.log("Mappen 'db' skapades.");
} else {
  console.log("Mappen 'db' finns redan.");
}
